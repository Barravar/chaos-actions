...
from .exceptions import LitmusRestError, LitmusAuthenticationError, LitmusGraphQLError
...
class LitmusClient:
  ...
  def _rest_call(self, method: str, path: str, **kwargs) -> requests.Response:
    """
  ...
  def _graphql_call(self, query: str, variables: Optional[dict[str, Any]]) -> dict[str, Any]:
    ...
    try:
      ...
      if "errors" in response_data:
        ...
        raise LitmusGraphQLError(f"GraphQL query returned errors: {response_data.get('errors')}")
